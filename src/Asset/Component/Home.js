      ...
      <div className='row align-items-center'>
        ...
        <div className='col-12  text-content '>
          ...
          <div className='social mt-4 ms-5'>
            <a href='https://www.linkedin.com/in/abhishek-gaikwad-b6819731b/' target="_blank" rel="noreferrer"><LinkedInIcon className="icon" /></a>
           <a href='https://www.facebook.com/abhishek.gaikwad.77736' target="_blank" rel="noreferrer"><FacebookIcon className="icon" /></a>
            <a href='https://www.instagram.com/abhishek_gaikwad_45/' target="_blank" rel="noreferrer"> <InstagramIcon className="icon" /></a>
           <a href='https://github.com/AbhishekGaikwad45' target="_blank" rel="noreferrer"><GitHubIcon className="icon" /></a>
