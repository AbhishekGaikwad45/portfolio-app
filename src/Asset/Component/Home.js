    ...
    <div className='home container-fluid'>
      <div className='row align-items-center'>
        ...
        <div className='col-12  text-content '>
          ...
          <div className="d-flex justify-content-start gap-3 flex-wrap mt-4 ms-5">

            <a
              href="/Abhishek Gaikwad.pdf"
              target="_blank"
              rel="noopener noreferrer"
              className="text-decoration-none"
            >
              <button className="btn btn-success btn-lg px-4 shadow d-flex align-items-center gap-2">
            ...
            <a
              href="/Abhishek_Gaikwad_java.pdf"
              target="_blank"
              rel="noopener noreferrer"
              className="text-decoration-none"
            >
              <button className="btn btn-danger btn-lg px-4 shadow d-flex align-items-center gap-2">
